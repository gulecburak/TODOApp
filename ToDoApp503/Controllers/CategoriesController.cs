...
namespace ToDoApp503.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public void ExportToExcel()
        {
            ...
            grid.DataSource = (from data in db.Categories
                               select new { Kategori = data.Name, O_Tarihi = data.CreateDate, O_Kullanici = data.CreatedBy, G_Tarihi = data.UpdateDate, G_Kullanici = data.UpdatedBy }).ToList();
            grid.DataBind();
            Response.Clear();
        ...
        {
            StringWriter sw = new StringWriter();
            sw.WriteLine("Kategori_Adi,O_Tarihi,O_Kullanici,G_Tarihi,G_Kullanici");
            ...
            {
                sw.WriteLine(string.Format("{0},{1},{2},{3},{4}", Category.Name,Category.CreateDate, Category.CreatedBy, Category.UpdateDate, Category.UpdatedBy));
            }
            Response.Write(sw.ToString());
            Response.End();
